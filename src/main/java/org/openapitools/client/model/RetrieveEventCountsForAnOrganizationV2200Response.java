...
public class RetrieveEventCountsForAnOrganizationV2200Response implements Serializable {
  ...
  * @throws IOException if the JSON Object is invalid with respect to RetrieveEventCountsForAnOrganizationV2200Response
  */
  public static void validateJsonObject(JsonObject jsonObj) throws IOException {
      if (jsonObj == null) {
        if (!RetrieveEventCountsForAnOrganizationV2200Response.openapiRequiredFields.isEmpty()) { // has required fields but JSON object is null
          throw new IllegalArgumentException(String.format("The required field(s) %s in RetrieveEventCountsForAnOrganizationV2200Response is not found in the empty JSON string", RetrieveEventCountsForAnOrganizationV2200Response.openapiRequiredFields.toString()));
        }
      }
      ...
      for (Entry<String, JsonElement> entry : entries) {
        if (!RetrieveEventCountsForAnOrganizationV2200Response.openapiFields.contains(entry.getKey())) {
          throw new IllegalArgumentException(String.format("The field `%s` in the JSON string is not defined in the `RetrieveEventCountsForAnOrganizationV2200Response` properties. JSON: %s", entry.getKey(), jsonObj.toString()));
        }
      }

      // check to make sure all required properties/fields are present in the JSON string
      for (String requiredField : RetrieveEventCountsForAnOrganizationV2200Response.openapiRequiredFields) {
  ...
  public static class CustomTypeAdapterFactory implements TypeAdapterFactory {
    ...
    public <T> TypeAdapter<T> create(Gson gson, TypeToken<T> type) {
       if (!RetrieveEventCountsForAnOrganizationV2200Response.class.isAssignableFrom(type.getRawType())) {
         return null; // this class only serializes 'RetrieveEventCountsForAnOrganizationV2200Response' and its subtypes
       }
       final TypeAdapter<JsonElement> elementAdapter = gson.getAdapter(JsonElement.class);
       final TypeAdapter<RetrieveEventCountsForAnOrganizationV2200Response> thisAdapter
                        = gson.getDelegateAdapter(this, TypeToken.get(RetrieveEventCountsForAnOrganizationV2200Response.class));

       return (TypeAdapter<T>) new TypeAdapter<RetrieveEventCountsForAnOrganizationV2200Response>() {
           @Override
           public void write(JsonWriter out, RetrieveEventCountsForAnOrganizationV2200Response value) throws IOException {
             JsonObject obj = thisAdapter.toJsonTree(value).getAsJsonObject();
             elementAdapter.write(out, obj);
           }

           @Override
           public RetrieveEventCountsForAnOrganizationV2200Response read(JsonReader in) throws IOException {
 ...
 /**
  * Create an instance of RetrieveEventCountsForAnOrganizationV2200Response given an JSON string
  *
  * @param jsonString JSON string
  * @return An instance of RetrieveEventCountsForAnOrganizationV2200Response
  * @throws IOException if the JSON string is invalid with respect to RetrieveEventCountsForAnOrganizationV2200Response
  */
  public static RetrieveEventCountsForAnOrganizationV2200Response fromJson(String jsonString) throws IOException {
    return JSON.getGson().fromJson(jsonString, RetrieveEventCountsForAnOrganizationV2200Response.class);
  }

 /**
  * Convert an instance of RetrieveEventCountsForAnOrganizationV2200Response to an JSON string
  *
  * @return JSON string
  */
